...
simopts.data.trainvsize = 10;                        % size (in samples) of the input vector
simopts.data.trainlen   = 500;                       % number of training vectors in the training data set 
...
simopts.net.maxepochs   = 1;                         % number of epochs to train
simopts.net.gamma       = 0.15;                      % cross-modal activation impact on local som learning
simopts.net.xi          = 0.01;                      % inhibitory component in sensory projections weight update
simopts.net.kappa       = 0.15;                      % learning rate (gain factor) in Hebbian weight update
