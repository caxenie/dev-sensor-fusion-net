...
simopts.data.trainvsize = 5;                          % size (in samples) of the input vector (only for sliding / interval / hunt )
...
simopts.net.kappa       = 0.0;                        % learning rate (gain factor) in Hebbian weight update
...
switch(simopts.mode)
    ...
    case 'analyze'
        ...
        simopts.data.infile = 'test_ordered_data.mat';
