...
simopts.data.ntrainv    = 1000;                       % number of trin vectors for training the network
...
switch(simopts.mode)
    ...
    case 'analyze'
        ...
        simopts.data.infile = sprintf('%d_epochs_%d_neurons_%s_source_data_%s_trainvsize_%d_trainvnum_%d_params_%s',...
