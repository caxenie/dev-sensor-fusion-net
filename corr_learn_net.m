...
switch(simopts.mode)
    case 'run'
        ...
        simopts.net.gamma = 0.35; % cross-modal influence factor
        simopts.net.xi = 0.27; % inhibitory component in sensory projections weight update
        simopts.net.kappa = 0.23; % learning rate (gain factot) in Hebbian weight update   
        ...
        % run the correlation learning network
